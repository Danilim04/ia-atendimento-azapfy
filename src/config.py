...
class Settings(BaseSettings):
    ...
    openrouter_model: str = Field(
        "anthropic/claude-sonnet-4", alias="OPENROUTER_MODEL"
    )
    openrouter_classifier_model: str = Field(
        "openai/gpt-4o-mini", alias="OPENROUTER_CLASSIFIER_MODEL"
    )
    ...
    pdf_path: Path = Field(Path("./docs/base.pdf"), alias="PDF_PATH")
